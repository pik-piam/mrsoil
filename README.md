...
R package **mrSOCbudget**, version **0.4.3**
...
Karstens K (2020). _mrSOCbudget: Calculates historical Soil Organic Carbon Budget for Cropland_. R package version 0.4.3.
